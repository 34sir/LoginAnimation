...
class CircularAnimatedDrawable extends Drawable implements Animatable {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        fBounds.left = bounds.left + 3*mBorderWidth + .5f;
        fBounds.right = bounds.right - 3*mBorderWidth  - .5f;
        fBounds.top = bounds.top + 3*mBorderWidth  + .5f;
        fBounds.bottom = bounds.bottom - 3*mBorderWidth  - .5f;
    }
